...
class Form extends Component {
    ...
    onSubmit(e) {
        ...
        if (window.location.href.includes("/create")) {
            ...
            axios.post("http://localhost:4000/admin/courses/create", newCourse, { params: {}, headers: { Authorization: `Bearer ${this.props.auth.getAccessToken()}` } }).then((res) => {
            ...
            axios.put(`http://localhost:4000/admin/courses/edit/${this.props.courseId}`, updatedCourse, { params: {}, headers: { Authorization: `Bearer ${this.props.auth.getAccessToken()}` } }).then((res) => {
    ...
    componentDidMount() {
        ...
        if (window.location.href.includes("/edit")) {
            ...
            axios.get(`http://localhost:4000/admin/courses/edit/${this.props.courseId}`, { params: {}, headers: { Authorization: `Bearer ${this.props.auth.getAccessToken()}` } })
                .then((res) => {
                    this.setState({
